...
class BaseBRDF(nn.Module):
    ...
    def sample_brdf(self, sample1, sample2, wo, normal, mat):
        ...
        wi[mask] = specular_sampler(
            sample2[mask], mat["roughness"][mask], wo[mask], normal[mask]
        )
...
class NGPBRDF(BaseBRDF):
    ...
    def __init__(self, voxel_min, voxel_max):
        ...
        self.mlp = tcnn.NetworkWithInputEncoding(3, 5, hash_encoding, hash_network)
...
class TextureBRDF(BaseBRDF):
    ...
    def __init__(self, res):
        ...
        self.register_parameter(
            "textures", nn.Parameter(torch.randn(self.res, self.res, 3 + 2) * 1e-2)
        )
